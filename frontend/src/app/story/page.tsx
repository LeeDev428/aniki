  ...
  return (
    <PageLayout>
      ...
      <section className="relative py-16 bg-dark-800">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <FadeIn className="text-center mb-8">
            <span className="inline-block px-4 py-1.5 mb-4 text-xs font-medium text-primary-400 bg-primary-400/20 rounded-full">
              Our Journey
            </span>
            ...
            <div className="relative aspect-video bg-dark-700 rounded-2xl overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-primary-400/20 flex items-center justify-center cursor-pointer hover:bg-primary-400/30 transition-colors"
                  ...
                  <p className="text-dark-300 text-sm">Watch Our Story</p>
                </div>
              </div>
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs text-dark-300">0:00 / 3:24</span>
                  </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <FadeIn className="text-center mb-12">
            <h2 className="text-2xl font-bold text-dark-800 mb-2">Our Timeline</h2>
            <p className="text-dark-500 text-sm">Key milestones in our journey</p>
          </FadeIn>

          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-4 lg:left-1/2 top-0 bottom-0 w-px bg-primary-200 -translate-x-1/2" />
                  ...
                  <div className={`flex items-center gap-6 ${index % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}>
                    <div className={`flex-1 ${index % 2 === 0 ? 'lg:text-right' : 'lg:text-left'} hidden lg:block`}>
                      <div className="p-5 bg-cream rounded-xl inline-block max-w-sm">
                        ...
                        <h3 className="font-semibold text-dark-800 mt-1">{milestone.title}</h3>
                        <p className="text-sm text-dark-500 mt-1">{milestone.description}</p>
                      </div>
                    </div>
                    
                    {/* Timeline Dot */}
                    <div className="relative z-10 w-8 h-8 rounded-full bg-primary-400 flex items-center justify-center flex-shrink-0">
      ...
      <section className="py-16 bg-cream">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          <FadeIn className="text-center mb-12">
            <h2 className="text-2xl font-bold text-dark-800 mb-2">What Collectors Say</h2>
            <p className="text-dark-500 text-sm">Stories from our community</p>
          </FadeIn>
              ...
              <StaggerItem key={index}>
                <div className="p-6 bg-white rounded-xl">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-medium text-dark-800 text-sm">{testimonial.author}</p>
                      <p className="text-xs text-dark-400">{testimonial.location}</p>
                    </div>
                  </div>
                  <p className="text-sm text-dark-500 italic">&ldquo;{testimonial.quote}&rdquo;</p>
                </div>
              </StaggerItem>
            ))}
          </StaggerContainer>
      ...
      <FadeIn>
        <section className="py-16 bg-gradient-to-r from-primary-400 to-primary-500">
          <div className="max-w-6xl mx-auto px-6 lg:px-8 text-center">
            ...
            <p className="text-dark-600 text-sm mb-6 max-w-lg mx-auto">
              Join our growing community of collectors and discover amazing figures.
            </p>
            <a
              href="/shop"
              className="inline-flex items-center gap-2 px-6 py-3 bg-dark-800 text-white rounded-full font-medium hover:bg-dark-700 transition-colors"
            >
              Start Collecting
            </a>
          </div>
