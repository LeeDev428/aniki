            ...
            {contactInfo.map((info, index) => (
              <StaggerItem key={index}>
                <div className="p-5 bg-cream rounded-xl text-center">
                  <div className="w-10 h-10 mx-auto mb-3 rounded-lg bg-honey-100 flex items-center justify-center">
                    <info.icon className="w-5 h-5 text-honey-600" />
                  </div>
                  <h3 className="font-medium text-neutral-900 text-sm">{info.title}</h3>
                  <p className="font-semibold text-neutral-900 mt-1">{info.content}</p>
                  <p className="text-xs text-neutral-500 mt-0.5">{info.subtitle}</p>
                </div>
              </StaggerItem>
            ))}
          </StaggerContainer>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <FadeIn direction="right">
              <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-sm">
                <h2 className="text-xl font-bold text-neutral-900 mb-2">Send us a Message</h2>
                ...
                {submitted ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-sm text-neutral-600">We&apos;ll get back to you soon.</p>
                  </div>
                ) : (
            ...
            <FadeIn direction="left" delay={0.2}>
              <div>
                <h2 className="text-xl font-bold text-neutral-900 mb-2">Quick Help</h2>
                <p className="text-sm text-neutral-600 mb-6">
                ...
                <div className="space-y-3 mb-8">
                  {quickHelp.map((item, index) => (
                    ...
                    >
                      <div className="w-10 h-10 rounded-lg bg-honey-100 flex items-center justify-center group-hover:bg-honey-200 transition-colors">
                ...
                {/* Map Placeholder */}
                <div className="bg-gradient-to-br from-honey-100 to-honey-200 rounded-xl aspect-video flex items-center justify-center">
                  <div className="text-center">
                    <span className="text-4xl mb-2 block">🗺️</span>
                    <p className="text-sm text-honey-700">Map coming soon</p>
                  </div>
                </div>
              </div>
            </FadeIn>
