...
export default function Hero() {
  return (
    <div className="flex-1 flex flex-col lg:flex-row items-center justify-center gap-8 px-8 py-12 relative">
      ...
      <div className="flex-1 max-w-xl z-10">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-auto">
          ...
          <div className="glass rounded-3xl p-6 flex-1">
            <p className="text-sm text-neutral-500 mb-1">Premium Quality</p>
            <h3 className="font-display text-3xl font-bold text-neutral-800 tracking-wide">
              100% OFFICIAL
            </h3>
            <Link 
              href="/shop"
              className="mt-4 flex items-center gap-2 px-5 py-3 bg-white rounded-full border border-neutral-200 hover:border-honey-400 hover:shadow-md transition-all group w-fit"
            >
          ...
          <div className="flex gap-3">
            ...
            <div className="glass rounded-2xl p-4 flex flex-col justify-between min-w-[100px]">
              ...
              <div>
                <span className="text-3xl font-bold text-neutral-800">500+</span>
                <span className="text-xs text-neutral-500 ml-1">Figures</span>
              </div>
            ...
            {/* Brands */}
            <div className="glass rounded-2xl p-4 flex flex-col justify-between min-w-[100px]">
              <span className="text-3xl font-bold text-neutral-800">20+</span>
              <span className="text-xs text-neutral-500">Top Brands</span>
      ...
      {/* Center - Featured Figure Placeholder */}
        ...
        <div className="relative w-80 h-96 lg:w-96 lg:h-[500px]">
          ...
          <div className="w-full h-full flex items-center justify-center">
            <div className="text-center text-neutral-400">
              ...
              <p className="mt-4 text-sm">Add your featured figure</p>
              <p className="text-xs">/public/hero-figure.png</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 max-w-xs z-10">
        <div className="glass rounded-3xl p-6">
          <p className="text-sm text-neutral-500 mb-1">Pre-Order Now &</p>
          <h3 className="font-display text-3xl font-bold text-neutral-800 tracking-wide mb-4">
            SAVE 10%
          </h3>
          <Link 
            href="/shop?category=pre-orders"
            className="flex items-center gap-2 px-5 py-3 bg-white rounded-full border border-neutral-200 hover:border-honey-400 hover:shadow-md transition-all group w-fit"
          >
